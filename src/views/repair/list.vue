<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="修复人">
        <template slot-scope="scope">
          <span>{{ scope.row.person }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="修复地点">
        <template slot-scope="scope">
          <span>{{ scope.row.location }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="修复原因">
        <template slot-scope="scope">
          <span>{{ scope.row.reason }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="修复技术措施">
        <template slot-scope="scope">
          <span>{{ scope.row.teck }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="修复方案">
        <template slot-scope="scope">
          <span>{{ scope.row.plan }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="情况及结果">
        <template slot-scope="scope">
    ...
    <!--添加操作的窗口-->
    <el-dialog title="添加修复记录" :visible.sync="inStoreFormVisible" lock-scroll :close-on-click-modal="false">
      <el-form ref="inForm" :model="dataform" :rules="rules">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="开始时间" :label-width="formLabelWidth" style="width:340px" prop="startTime">
              <el-date-picker v-model="dataform.startTime" class="filter-item" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm:ss" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="结束时间" :label-width="formLabelWidth" style="width:340px" prop="endTime">
              <el-date-picker v-model="dataform.endTime" class="filter-item" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm:ss" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="承担单位" :label-width="formLabelWidth">
              <el-input v-model="dataform.department" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="修复人" :label-width="formLabelWidth">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="修复地点" :label-width="formLabelWidth">
              <el-input v-model="dataform.location" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="修复原因" :label-width="formLabelWidth">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="修复技术措施" :label-width="formLabelWidth">
              <el-input v-model="dataform.teck" type="textarea" placeholder="请输入修复技术措施" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label="修复方案" :label-width="formLabelWidth">
              <el-input v-model="dataform.plan" type="textarea" placeholder="请输入修复方案" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label="修复情况及结果" :label-width="formLabelWidth">
              <el-input v-model="dataform.result" type="textarea" placeholder="请输入修复情况及结果" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
<script>
import * as accident from '@/api/repair'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        startTime: [{ required: true, message: '发生时间为必填项', trigger: 'blur' }],
        endTime: [{ required: true, message: '发生时间为必填项', trigger: 'blur' }]
      }
    }
  },
  created() {
